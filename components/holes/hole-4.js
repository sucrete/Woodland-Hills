  ...
  render() {
    ...
    <div class="container contact__form px-lg-5">
        <div class="row d-flex flex-column-reverse flex-lg-row justify-content-between g-0">
            ...
            <h2 class="mb-0 pt-4 pb-0 pr-0 pl-1 pt-lg-0">Hole 4</h2>
                  ...
                  <table class="table tee-table tee-table-top">
                    <tbody>
                      ...
                      <tr class="handicap">
                        <td >Handicap of 15 for Men | Handicap of 17 for Ladies</td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div class="col col-12 col-lg-6 ">
                <figure class="mb-0">
                  <img src="./assets/images/1_golf_images/holes/hole4.jpeg" alt="image of hole four from behind the green"
